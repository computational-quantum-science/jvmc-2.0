...
class TesDT_PARAMS_CPXNet(unittest.TestCase):
    ...
    def test_cpx_cnn_1d(self):
        ...
        self.assertTrue(params['params']['Conv_1']['kernel'].dtype == jVMC.global_defs.DT_PARAMS_CPX)
        self.assertTrue(params['params']['Conv_1']['bias'].dtype == jVMC.global_defs.DT_PARAMS_CPX)
